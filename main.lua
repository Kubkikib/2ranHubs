...
-- Kömür getirme işlevi
local function GetCoal()
    -- Burada kömür getirme kodunu yazıyoruz
    local coal = Instance.new("Part")
    coal.Name = "Coal"
    coal.Size = Vector3.new(1, 1, 1)
    coal.Position = LocalPlayer.Character.HumanoidRootPart.Position + Vector3.new(0, 10, 0)  -- Karakterin üstüne doğru 10 birim yükseklik ekliyoruz
    coal.Parent = game.Workspace
end

-- Kömür getirme butonu
local CoalButton = Instance.new("TextButton")
CoalButton.Size = UDim2.new(1, 0, 0.25, 0)
CoalButton.Position = UDim2.new(0, 0, 1.55, 0) -- Yeni buton konumu
CoalButton.Text = "Kömür Getir"
CoalButton.TextColor3 = Color3.fromRGB(255, 255, 255)
CoalButton.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
CoalButton.Parent = MainFrame

CoalButton.MouseButton1Click:Connect(function()
    GetCoal()  -- Kömür getirme işlevini tetikle
end)
